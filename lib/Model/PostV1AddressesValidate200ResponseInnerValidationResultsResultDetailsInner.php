<?php
/**
 * PostV1AddressesValidate200ResponseInnerValidationResultsResultDetailsInner
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PostV1AddressesValidate200ResponseInnerValidationResultsResultDetailsInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PostV1AddressesValidate200ResponseInnerValidationResultsResultDetailsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_v1_addresses_validate_200_response_inner_validation_results_result_details_inner';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('detail_description', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets detail_code
     *
     * @param string|null $detail_code detail_code
     *
     * @return self
     */
    public function setDetailCode($detail_code)
    {
        if (is_null($detail_code)) {
            throw new \InvalidArgumentException('non-nullable detail_code cannot be null');
        }
     ...
     *
     * @param string|null $detail_description detail_description
     *
     * @return self
     */
    public function setDetailDescription($detail_description)
    {
        if (is_null($detail_description)) {
            throw new \InvalidArgumentException('non-nullable detail_description cannot be null');
        }

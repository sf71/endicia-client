...
class AccountBalance implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'max_balance_amount_allowed' => 'float',
        'currency' => 'string'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'max_balance_amount_allowed' => null,
        'currency' => null
    ];
    ...
    protected static array $openAPINullables = [
		...
		'max_balance_amount_allowed' => false,
		'currency' => false
    ];
    ...
    protected static $attributeMap = [
        ...
        'max_balance_amount_allowed' => 'max_balance_amount_allowed',
        'currency' => 'currency'
    ];
    ...
    protected static $setters = [
        ...
        'max_balance_amount_allowed' => 'setMaxBalanceAmountAllowed',
    ...
    protected static $getters = [
        ...
        'max_balance_amount_allowed' => 'getMaxBalanceAmountAllowed',
    ...
    {
        $this->setIfExists('amount_available', $data ?? [], null);
        $this->setIfExists('max_balance_amount_allowed', $data ?? [], null);
    ...
    */
     ...
     *
     * @param float|null $amount_available _Amount Available_<br/>The current account balance available for use
     *
     * @return self
     */
    public function setAmountAvailable($amount_available)
    {
        if (is_null($amount_available)) {
            throw new \InvalidArgumentException('non-nullable amount_available cannot be null');
        }
    ...
    /**
     * Gets max_balance_amount_allowed
     *
     * @return float|null
     */
    public function getMaxBalanceAmountAllowed()
    {
        return $this->container['max_balance_amount_allowed'];
    }

    /**
     * Sets max_balance_amount_allowed
     *
     * @param float|null $max_balance_amount_allowed _Maximum Balance Amount Allowed_<br/>The maximum allowed account balance for the current account
     *
     * @return self
     */
    public function setMaxBalanceAmountAllowed($max_balance_amount_allowed)
    {
        if (is_null($max_balance_amount_allowed)) {
            throw new \InvalidArgumentException('non-nullable max_balance_amount_allowed cannot be null');
        }
        $this->container['max_balance_amount_allowed'] = $max_balance_amount_allowed;
     ...
     * Sets currency
     *
     * @param string|null $currency The currency used for the associated `amount_available` field.
     *
     * @return self
     */

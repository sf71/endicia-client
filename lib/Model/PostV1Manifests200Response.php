...
/**
 * PostV1Manifests200Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PostV1Manifests200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_v1_manifests_200_response';
    ...
    protected static $openAPITypes = [
        ...
        'carrier' => 'string',
        'ship_date' => 'string',
        'number_of_items_in_manifest' => 'float',
    ...
    protected static $openAPIFormats = [
        ...
        'carrier' => null,
        'ship_date' => null,
        'number_of_items_in_manifest' => null,
        'labels' => null
    ];
    ...
    protected static array $openAPINullables = [
		...
		'carrier' => false,
		'ship_date' => false,
		'number_of_items_in_manifest' => false,
		'labels' => false
    ];
    ...
    protected static $attributeMap = [
        ...
        'carrier' => 'carrier',
        'ship_date' => 'ship_date',
        'number_of_items_in_manifest' => 'number_of_items_in_manifest',
        'labels' => 'labels'
    ];
    ...
    protected static $setters = [
        ...
        'number_of_items_in_manifest' => 'setNumberOfItemsInManifest',
        'labels' => 'setLabels'
    ];
    ...
    protected static $getters = [
        ...
        'number_of_items_in_manifest' => 'getNumberOfItemsInManifest',
        'labels' => 'getLabels'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('number_of_items_in_manifest', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets number_of_items_in_manifest
     *
     * @return float|null
     */
    public function getNumberOfItemsInManifest()
    {
        return $this->container['number_of_items_in_manifest'];
    }

    /**
     * Sets number_of_items_in_manifest
     *
     * @param float|null $number_of_items_in_manifest number_of_items_in_manifest
     *
     * @return self
     */
    public function setNumberOfItemsInManifest($number_of_items_in_manifest)
    {
        if (is_null($number_of_items_in_manifest)) {
            throw new \InvalidArgumentException('non-nullable number_of_items_in_manifest cannot be null');
        }
        $this->container['number_of_items_in_manifest'] = $number_of_items_in_manifest;

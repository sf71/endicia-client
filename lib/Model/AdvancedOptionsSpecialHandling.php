<?php
/**
 * AdvancedOptionsSpecialHandling
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * AdvancedOptionsSpecialHandling Class Doc Comment
 *
 * @category Class
 * @description _Special Handling_
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class AdvancedOptionsSpecialHandling implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'advanced_options_special_handling';
    ...
    protected static $attributeMap = [
        'special_contents_type' => 'special_contents_type',
        'fragile' => 'fragile'
    ];
    ...
    protected static $setters = [
        'special_contents_type' => 'setSpecialContentsType',
        'fragile' => 'setFragile'
    ];
    ...
    protected static $getters = [
        'special_contents_type' => 'getSpecialContentsType',
        'fragile' => 'getFragile'
    ];
    ...
    public const SPECIAL_CONTENTS_TYPE_HAZARDOUS_MATERIALS = 'hazardous_materials';
    public const SPECIAL_CONTENTS_TYPE_PERISHABLES = 'perishables';
    public const SPECIAL_CONTENTS_TYPE_CREMATED_REMAINS = 'cremated_remains';
    public const SPECIAL_CONTENTS_TYPE_LIVE_ANIMALS = 'live_animals';
    public const SPECIAL_CONTENTS_TYPE_LIVE_ANIMALS_WITH_FEE = 'live_animals_with_fee';
     ...
     * @return string[]
     */
    public function getSpecialContentsTypeAllowableValues()
    {
        return [
            self::SPECIAL_CONTENTS_TYPE_HAZARDOUS_MATERIALS,
            self::SPECIAL_CONTENTS_TYPE_PERISHABLES,
            self::SPECIAL_CONTENTS_TYPE_CREMATED_REMAINS,
            self::SPECIAL_CONTENTS_TYPE_LIVE_ANIMALS,
            self::SPECIAL_CONTENTS_TYPE_LIVE_ANIMALS_WITH_FEE,
        ];
    }
    ...
    {
        $this->setIfExists('special_contents_type', $data ?? [], null);
        $this->setIfExists('fragile', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getSpecialContentsTypeAllowableValues();
        if (!is_null($this->container['special_contents_type']) && !in_array($this->container['special_contents_type'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'special_contents_type', must be one of '%s'",
                $this->container['special_contents_type'],
    ...
    /**
     * Gets special_contents_type
     *
     * @return string|null
     */
    public function getSpecialContentsType()
    {
        return $this->container['special_contents_type'];
    }

    /**
     * Sets special_contents_type
     *
     * @param string|null $special_contents_type _Special Handling Contents Type_
     *
     * @return self
     */
    public function setSpecialContentsType($special_contents_type)
    {
        if (is_null($special_contents_type)) {
            throw new \InvalidArgumentException('non-nullable special_contents_type cannot be null');
        }
        $allowedValues = $this->getSpecialContentsTypeAllowableValues();
        if (!in_array($special_contents_type, $allowedValues, true)) {
        ...
        $this->container['special_contents_type'] = $special_contents_type;
    ...
    {
        return $this->container['fragile'];
    }

    /**
     * Sets fragile
     *
     * @param bool|null $fragile _Special Handling: Fragile_
     *
     * @return self
     */
    ...
    {
        if (is_null($fragile)) {
            throw new \InvalidArgumentException('non-nullable fragile cannot be null');
        }
        $this->container['fragile'] = $fragile;

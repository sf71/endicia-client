...
/**
 * GetV1Tracking200Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetV1Tracking200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_v1_tracking_200_response';
    ...
    protected static $openAPITypes = [
        ...
        'destination' => '\OpenAPI\Client\Model\GetV1Tracking200ResponseDestination',
        'tracking_events' => '\OpenAPI\Client\Model\GetV1Tracking200ResponseTrackingEventsInner[]'
    ];
    ...
    public const STATUS_CODE_EXCEPTION = 'exception';
    public const STATUS_CODE_AWAITING_SHIPMENT = 'awaiting_shipment';
    public const STATUS_CODE_IN_TRANSIT = 'in_transit';
    ...
    public function getStatusCodeAllowableValues()
    {
        return [
            ...
            self::STATUS_CODE_EXCEPTION,
            self::STATUS_CODE_AWAITING_SHIPMENT,
            self::STATUS_CODE_IN_TRANSIT,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('carrier_status_description', $data ?? [], null);
    ...
    */
     ...
     *
     * @param string|null $carrier_status_description carrier_status_description
     *
     * @return self
     */
    public function setCarrierStatusDescription($carrier_status_description)
    {
        if (is_null($carrier_status_description)) {
            throw new \InvalidArgumentException('non-nullable carrier_status_description cannot be null');
        }
     ...
     * Gets destination
     *
     * @return \OpenAPI\Client\Model\GetV1Tracking200ResponseDestination|null
     */
     ...
     * Sets destination
     *
     * @param \OpenAPI\Client\Model\GetV1Tracking200ResponseDestination|null $destination destination
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\GetV1Tracking200ResponseTrackingEventsInner[]|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\GetV1Tracking200ResponseTrackingEventsInner[]|null $tracking_events tracking_events
     *
     * @return self
     */

...
/**
 * ConfiguredCarrier Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ConfiguredCarrier implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'configured_carrier';
    ...
    protected static $attributeMap = [
        'carrier' => 'carrier',
        'customer_owned_account' => 'customer_owned_account'
    ];
    ...
    protected static $setters = [
        'carrier' => 'setCarrier',
        'customer_owned_account' => 'setCustomerOwnedAccount'
    ];
    ...
    protected static $getters = [
        'carrier' => 'getCarrier',
        'customer_owned_account' => 'getCustomerOwnedAccount'
    ];
    ...
    public const CARRIER_DHL_ECOMMERCE = 'dhl_ecommerce';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('customer_owned_account', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets customer_owned_account
     *
     * @return bool|null
     */
    public function getCustomerOwnedAccount()
    {
        return $this->container['customer_owned_account'];
    }

    /**
     * Sets customer_owned_account
     *
     * @param bool|null $customer_owned_account _Customer Owned Account_
     *
     * @return self
     */
    public function setCustomerOwnedAccount($customer_owned_account)
    {
        if (is_null($customer_owned_account)) {
            throw new \InvalidArgumentException('non-nullable customer_owned_account cannot be null');
        }
        $this->container['customer_owned_account'] = $customer_owned_account;

...
/**
 * ShipmentCostCostDetailsInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ShipmentCostCostDetailsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'shipment_cost_cost_details_inner';
    ...
    public const FEE_TYPE_SERVICE = 'service';
    public const FEE_TYPE_TRACKING = 'tracking';
    ...
    {
        return [
            self::FEE_TYPE_SERVICE,
            self::FEE_TYPE_TRACKING,
    ...
    */
     ...
     * Sets fee_code
     *
     * @param string|null $fee_code fee_code
     *
     * @return self
     */

...
/**
 * PostV1RatesRequestInsurance Class Doc Comment
 *
 * @category Class
 * @description _Insurance_
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class PostV1RatesRequestInsurance implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_v1_rates_request_insurance';
    ...
    protected static $openAPITypes = [
        ...
        'insured_value' => '\OpenAPI\Client\Model\PostV1RatesRequestInsuranceInsuredValue'
    ];
    ...
    public const INSURANCE_PROVIDER_STAMPS_COM = 'stamps_com';
    public const INSURANCE_PROVIDER_CARRIER = 'carrier';
    public const INSURANCE_PROVIDER_PARCEL_GUARD = 'parcel_guard';
     ...
     * @return string[]
     */
    public function getInsuranceProviderAllowableValues()
    {
        return [
            self::INSURANCE_PROVIDER_STAMPS_COM,
            self::INSURANCE_PROVIDER_CARRIER,
            self::INSURANCE_PROVIDER_PARCEL_GUARD,
        ];
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getInsuranceProviderAllowableValues();
        if (!is_null($this->container['insurance_provider']) && !in_array($this->container['insurance_provider'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'insurance_provider', must be one of '%s'",
                $this->container['insurance_provider'],
     ...
     *
     * @param string|null $insurance_provider _Insurance Provider_
     *
     * @return self
     */
    public function setInsuranceProvider($insurance_provider)
    {
        ...
        $allowedValues = $this->getInsuranceProviderAllowableValues();
        if (!in_array($insurance_provider, $allowedValues, true)) {
     ...
     * Gets insured_value
     *
     * @return \OpenAPI\Client\Model\PostV1RatesRequestInsuranceInsuredValue|null
     */
     ...
     * Sets insured_value
     *
     * @param \OpenAPI\Client\Model\PostV1RatesRequestInsuranceInsuredValue|null $insured_value insured_value
     *
     * @return self
     */

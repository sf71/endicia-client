...
/**
 * AdvancedOptionsNoLabel Class Doc Comment
 *
 * @category Class
 * @description _No Label_
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class AdvancedOptionsNoLabel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'advanced_options_no_label';
    ...
    protected static $setters = [
        'is_drop_off' => 'setIsDropOff',
        'is_prepackaged' => 'setIsPrepackaged'
    ];
    ...
    protected static $getters = [
        'is_drop_off' => 'getIsDropOff',
        'is_prepackaged' => 'getIsPrepackaged'
    ];
    ...
    {
        $this->setIfExists('is_drop_off', $data ?? [], null);
        $this->setIfExists('is_prepackaged', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['is_drop_off'];
    }

    /**
     * Sets is_drop_off
     *
     * @param bool|null $is_drop_off _No Label Is Drop Off_
     *
     * @return self
     */
    public function setIsDropOff($is_drop_off)
    {
        if (is_null($is_drop_off)) {
            throw new \InvalidArgumentException('non-nullable is_drop_off cannot be null');
        }
        $this->container['is_drop_off'] = $is_drop_off;
    ...
    {
        return $this->container['is_prepackaged'];
    }

    /**
     * Sets is_prepackaged
     *
     * @param bool|null $is_prepackaged _No Label Is Prepackaged_
     *
     * @return self
     */
    public function setIsPrepackaged($is_prepackaged)
    {
        if (is_null($is_prepackaged)) {
            throw new \InvalidArgumentException('non-nullable is_prepackaged cannot be null');
        }
        $this->container['is_prepackaged'] = $is_prepackaged;

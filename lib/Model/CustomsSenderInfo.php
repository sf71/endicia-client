...
/**
 * CustomsSenderInfo Class Doc Comment
 *
 * @category Class
 * @description _Customs Sender Information_
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CustomsSenderInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'customs_sender_info';
    ...
    protected static array $openAPINullables = [
		...
		'internal_transaction_number' => false,
    ...
    protected static $setters = [
        ...
        'internal_transaction_number' => 'setInternalTransactionNumber',
    ...
    protected static $getters = [
        ...
        'internal_transaction_number' => 'getInternalTransactionNumber',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('internal_transaction_number', $data ?? [], null);
        $this->setIfExists('passport_number', $data ?? [], null);
        $this->setIfExists('passport_issue_date', $data ?? [], null);
        $this->setIfExists('passport_expiration_date', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets license_number
     *
     * @param string|null $license_number _Customs Sender License Number_
     *
     * @return self
     */
     ...
     *
     * @param string|null $certificate_number _Customs Sender Certificate Number_
     *
     * @return self
     */
     ...
     * Sets invoice_number
     *
     * @param string|null $invoice_number _Customs Sender Invoice Number_
     *
     * @return self
     */
    ...
    /**
     * Gets internal_transaction_number
     *
     * @return string|null
     */
    public function getInternalTransactionNumber()
    {
        return $this->container['internal_transaction_number'];
    }

    /**
     * Sets internal_transaction_number
     *
     * @param string|null $internal_transaction_number _Customs Sender Internal Transaction Number_
     *
     * @return self
     */
    public function setInternalTransactionNumber($internal_transaction_number)
    {
        if (is_null($internal_transaction_number)) {
            throw new \InvalidArgumentException('non-nullable internal_transaction_number cannot be null');
        }
        $this->container['internal_transaction_number'] = $internal_transaction_number;
     ...
     *
     * @param string|null $passport_number _Customs Sender Passport Number_
     *
     * @return self
     */
     ...
     *
     * @param string|null $passport_issue_date _Customs Sender Passport Issue Date_
     *
     * @return self
     */
     ...
     *
     * @param string|null $passport_expiration_date _Customs Sender Passport Expiration Date_
     *
     * @return self
     */
    public function setPassportExpirationDate($passport_expiration_date)
    {
        if (is_null($passport_expiration_date)) {
            throw new \InvalidArgumentException('non-nullable passport_expiration_date cannot be null');
        }

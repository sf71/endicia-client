...
/**
 * CustomsRecipientInfo Class Doc Comment
 *
 * @category Class
 * @description _Customs Recipient Information_
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CustomsRecipientInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'customs_recipient_info';
    ...
    */
     ...
     * Sets tax_id
     *
     * @param string|null $tax_id _Customs Recipient Tax ID_
     *
     * @return self
     */

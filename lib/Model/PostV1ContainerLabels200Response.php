<?php
/**
 * PostV1ContainerLabels200Response
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PostV1ContainerLabels200Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PostV1ContainerLabels200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_v1_container_labels_200_response';
    ...
    protected static $openAPITypes = [
        ...
        'carrier' => 'string',
        'ship_date' => 'string',
        'number_of_items_in_container_labels' => 'float',
        'number_of_container_labels' => 'float',
        'labels' => '\OpenAPI\Client\Model\PostV1Manifests200ResponseLabelsInner[]'
    ];
    ...
    protected static $openAPIFormats = [
        'container_label_id' => null,
        'tracking_numbers' => null,
        'carrier' => null,
        'ship_date' => null,
        'number_of_items_in_container_labels' => null,
        'number_of_container_labels' => null,
        'labels' => null
    ];
    ...
    protected static array $openAPINullables = [
        'container_label_id' => false,
		'tracking_numbers' => false,
		'carrier' => false,
		'ship_date' => false,
		'number_of_items_in_container_labels' => false,
		'number_of_container_labels' => false,
		'labels' => false
    ];
    ...
    protected static $attributeMap = [
        'container_label_id' => 'container_label_id',
        'tracking_numbers' => 'tracking_numbers',
        'carrier' => 'carrier',
        'ship_date' => 'ship_date',
        'number_of_items_in_container_labels' => 'number_of_items_in_container_labels',
        'number_of_container_labels' => 'number_of_container_labels',
        'labels' => 'labels'
    ];
    ...
    protected static $setters = [
        'container_label_id' => 'setContainerLabelId',
        'tracking_numbers' => 'setTrackingNumbers',
        'carrier' => 'setCarrier',
        'ship_date' => 'setShipDate',
        'number_of_items_in_container_labels' => 'setNumberOfItemsInContainerLabels',
        'number_of_container_labels' => 'setNumberOfContainerLabels',
        'labels' => 'setLabels'
    ];
    ...
    protected static $getters = [
        'container_label_id' => 'getContainerLabelId',
        'tracking_numbers' => 'getTrackingNumbers',
        'carrier' => 'getCarrier',
        'ship_date' => 'getShipDate',
        'number_of_items_in_container_labels' => 'getNumberOfItemsInContainerLabels',
        'number_of_container_labels' => 'getNumberOfContainerLabels',
        'labels' => 'getLabels'
    ];
    ...
    {
        $this->setIfExists('container_label_id', $data ?? [], null);
        $this->setIfExists('tracking_numbers', $data ?? [], null);
        $this->setIfExists('carrier', $data ?? [], null);
        $this->setIfExists('ship_date', $data ?? [], null);
        $this->setIfExists('number_of_items_in_container_labels', $data ?? [], null);
        $this->setIfExists('number_of_container_labels', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets container_label_id
     *
     * @return string|null
     */
    public function getContainerLabelId()
    {
        return $this->container['container_label_id'];
    }

    /**
     * Sets container_label_id
     *
     * @param string|null $container_label_id container_label_id
     *
     * @return self
     */
    public function setContainerLabelId($container_label_id)
    {
        if (is_null($container_label_id)) {
            throw new \InvalidArgumentException('non-nullable container_label_id cannot be null');
        }
        $this->container['container_label_id'] = $container_label_id;
     ...
     *
     * @param string[]|null $tracking_numbers tracking_numbers
     *
     * @return self
     */
    ...
    /**
     * Gets number_of_items_in_container_labels
     *
     * @return float|null
     */
    public function getNumberOfItemsInContainerLabels()
    {
        return $this->container['number_of_items_in_container_labels'];
    }

    /**
     * Sets number_of_items_in_container_labels
     *
     * @param float|null $number_of_items_in_container_labels number_of_items_in_container_labels
     *
     * @return self
     */
    public function setNumberOfItemsInContainerLabels($number_of_items_in_container_labels)
    {
        if (is_null($number_of_items_in_container_labels)) {
            throw new \InvalidArgumentException('non-nullable number_of_items_in_container_labels cannot be null');
        }
        $this->container['number_of_items_in_container_labels'] = $number_of_items_in_container_labels;

        return $this;
    }

    /**
     * Gets number_of_container_labels
     *
     * @return float|null
     */
    public function getNumberOfContainerLabels()
    {
        return $this->container['number_of_container_labels'];
    }

    /**
     * Sets number_of_container_labels
     *
     * @param float|null $number_of_container_labels number_of_container_labels
     *
     * @return self
     */
    public function setNumberOfContainerLabels($number_of_container_labels)
    {
        if (is_null($number_of_container_labels)) {
            throw new \InvalidArgumentException('non-nullable number_of_container_labels cannot be null');
        }
        $this->container['number_of_container_labels'] = $number_of_container_labels;
     ...
     * Gets labels
     *
     * @return \OpenAPI\Client\Model\PostV1Manifests200ResponseLabelsInner[]|null
     */
     ...
     * Sets labels
     *
     * @param \OpenAPI\Client\Model\PostV1Manifests200ResponseLabelsInner[]|null $labels labels
     *
     * @return self
     */

...
/**
 * ManifestLabelOptions Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ManifestLabelOptions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'manifest_label_options';
    ...
    protected static $setters = [
        ...
        'print_instructions' => 'setPrintInstructions'
    ];
    ...
    protected static $getters = [
        ...
        'print_instructions' => 'getPrintInstructions'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('print_instructions', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets print_instructions
     *
     * @return bool|null
     */
    public function getPrintInstructions()
    {
        return $this->container['print_instructions'];
    }

    /**
     * Sets print_instructions
     *
     * @param bool|null $print_instructions print_instructions
     *
     * @return self
     */
    public function setPrintInstructions($print_instructions)
    {
        if (is_null($print_instructions)) {
            throw new \InvalidArgumentException('non-nullable print_instructions cannot be null');
        }
        $this->container['print_instructions'] = $print_instructions;

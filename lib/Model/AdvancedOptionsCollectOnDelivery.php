<?php
/**
 * AdvancedOptionsCollectOnDelivery
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * AdvancedOptionsCollectOnDelivery Class Doc Comment
 *
 * @category Class
 * @description _Collect on Delivery (COD)_
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class AdvancedOptionsCollectOnDelivery implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'advanced_options_collect_on_delivery';
    ...
    */
     ...
     * Sets amount
     *
     * @param float|null $amount _COD Amount_
     *
     * @return self
     */
     ...
     * Sets currency
     *
     * @param string|null $currency _COD Amount Currency_
     *
     * @return self
     */

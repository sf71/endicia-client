...
class Invoice implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('control_id', $data ?? [], null);
        $this->setIfExists('invoice_number', $data ?? [], null);
        $this->setIfExists('invoice_amount', $data ?? [], 0);
    ...
    */
     ...
     * Sets control_id
     *
     * @param string $control_id control_id
     *
     * @return self
     */
    public function setControlId($control_id)
    {
        if (is_null($control_id)) {
            throw new \InvalidArgumentException('non-nullable control_id cannot be null');
        }

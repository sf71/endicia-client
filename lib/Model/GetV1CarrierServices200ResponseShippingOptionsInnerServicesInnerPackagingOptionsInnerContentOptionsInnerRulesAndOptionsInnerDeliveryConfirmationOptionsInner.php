...
/**
 * GetV1CarrierServices200ResponseShippingOptionsInnerServicesInnerPackagingOptionsInnerContentOptionsInnerRulesAndOptionsInnerDeliveryConfirmationOptionsInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetV1CarrierServices200ResponseShippingOptionsInnerServicesInnerPackagingOptionsInnerContentOptionsInnerRulesAndOptionsInnerDeliveryConfirmationOptionsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_v1_carrier_services_200_response_shipping_options_inner_services_inner_packaging_options_inner_content_options_inner_rules_and_options_inner_delivery_confirmation_options_inner';
    ...
    protected static $openAPITypes = [
        ...
        'delivery_confirmation_price' => 'float',
    ...
    protected static $openAPIFormats = [
        ...
        'delivery_confirmation_name' => null,
        'delivery_confirmation_price' => null,
    ...
    protected static array $openAPINullables = [
		...
		'delivery_confirmation_name' => false,
		'delivery_confirmation_price' => false,
    ...
    protected static $attributeMap = [
        ...
        'delivery_confirmation_name' => 'delivery_confirmation_name',
        'delivery_confirmation_price' => 'delivery_confirmation_price',
    ...
    protected static $setters = [
        ...
        'delivery_confirmation_name' => 'setDeliveryConfirmationName',
        'delivery_confirmation_price' => 'setDeliveryConfirmationPrice',
    ...
    protected static $getters = [
        ...
        'delivery_confirmation_name' => 'getDeliveryConfirmationName',
        'delivery_confirmation_price' => 'getDeliveryConfirmationPrice',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('delivery_confirmation_name', $data ?? [], null);
        $this->setIfExists('delivery_confirmation_price', $data ?? [], null);
    ...
    */
     ...
     *
     * @param string|null $delivery_confirmation_type delivery_confirmation_type
     *
     * @return self
     */
    ...
    /**
     * Gets delivery_confirmation_name
     *
     * @return string|null
     */
    public function getDeliveryConfirmationName()
    {
        return $this->container['delivery_confirmation_name'];
    }

    /**
     * Sets delivery_confirmation_name
     *
     * @param string|null $delivery_confirmation_name delivery_confirmation_name
     *
     * @return self
     */
    public function setDeliveryConfirmationName($delivery_confirmation_name)
    {
        if (is_null($delivery_confirmation_name)) {
            throw new \InvalidArgumentException('non-nullable delivery_confirmation_name cannot be null');
        }
        $this->container['delivery_confirmation_name'] = $delivery_confirmation_name;

        return $this;
    }

    /**
     * Gets delivery_confirmation_price
     *
     * @return float|null
     */
    public function getDeliveryConfirmationPrice()
    {
        return $this->container['delivery_confirmation_price'];
    }

    /**
     * Sets delivery_confirmation_price
     *
     * @param float|null $delivery_confirmation_price delivery_confirmation_price
     *
     * @return self
     */
    public function setDeliveryConfirmationPrice($delivery_confirmation_price)
    {
        if (is_null($delivery_confirmation_price)) {
            throw new \InvalidArgumentException('non-nullable delivery_confirmation_price cannot be null');
        }
        $this->container['delivery_confirmation_price'] = $delivery_confirmation_price;

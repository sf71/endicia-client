<?php
/**
 * GetV1CarrierServices200ResponseShippingOptionsInnerServicesInner
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * GetV1CarrierServices200ResponseShippingOptionsInnerServicesInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetV1CarrierServices200ResponseShippingOptionsInnerServicesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_v1_carrier_services_200_response_shipping_options_inner_services_inner';
    ...
    protected static $openAPITypes = [
        'service_type' => 'string',
        'service_name' => 'string',
        'packaging_options' => '\OpenAPI\Client\Model\GetV1CarrierServices200ResponseShippingOptionsInnerServicesInnerPackagingOptionsInner[]'
    ];
    ...
    protected static $setters = [
        ...
        'packaging_options' => 'setPackagingOptions'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('packaging_options', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets packaging_options
     *
     * @return \OpenAPI\Client\Model\GetV1CarrierServices200ResponseShippingOptionsInnerServicesInnerPackagingOptionsInner[]|null
     */
    public function getPackagingOptions()
    {
        return $this->container['packaging_options'];
    }

    /**
     * Sets packaging_options
     *
     * @param \OpenAPI\Client\Model\GetV1CarrierServices200ResponseShippingOptionsInnerServicesInnerPackagingOptionsInner[]|null $packaging_options packaging_options
     *
     * @return self
     */
    public function setPackagingOptions($packaging_options)
    {
        if (is_null($packaging_options)) {
            throw new \InvalidArgumentException('non-nullable packaging_options cannot be null');
        }
        $this->container['packaging_options'] = $packaging_options;

<?php
/**
 * PutV1AccountSecurityQuestionsRequest
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PutV1AccountSecurityQuestionsRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PutV1AccountSecurityQuestionsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'put_v1_account_security_questions_request';
    ...
    protected static $openAPIFormats = [
        'security_question1_type' => null,
        'security_question1_value' => null,
        'security_question2_type' => null,
        'security_question2_value' => null
    ];
    ...
    protected static array $openAPINullables = [
        'security_question1_type' => false,
		'security_question1_value' => false,
		'security_question2_type' => false,
		'security_question2_value' => false
    ];
    ...
    protected static $attributeMap = [
        'security_question1_type' => 'security_question1_type',
        'security_question1_value' => 'security_question1_value',
        'security_question2_type' => 'security_question2_type',
    ...
    protected static $setters = [
        'security_question1_type' => 'setSecurityQuestion1Type',
        'security_question1_value' => 'setSecurityQuestion1Value',
        'security_question2_type' => 'setSecurityQuestion2Type',
        'security_question2_value' => 'setSecurityQuestion2Value'
    ];
    ...
    protected static $getters = [
        'security_question1_type' => 'getSecurityQuestion1Type',
        'security_question1_value' => 'getSecurityQuestion1Value',
        'security_question2_type' => 'getSecurityQuestion2Type',
        'security_question2_value' => 'getSecurityQuestion2Value'
    ];
    ...
    {
        $this->setIfExists('security_question1_type', $data ?? [], null);
        $this->setIfExists('security_question1_value', $data ?? [], null);
        $this->setIfExists('security_question2_type', $data ?? [], null);
        $this->setIfExists('security_question2_value', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['security_question1_type'] === null) {
            $invalidProperties[] = "'security_question1_type' can't be null";
        }
        if ($this->container['security_question1_value'] === null) {
            $invalidProperties[] = "'security_question1_value' can't be null";
        }
        if ((mb_strlen($this->container['security_question1_value']) > 33)) {
            $invalidProperties[] = "invalid value for 'security_question1_value', the character length must be smaller than or equal to 33.";
        }

        if ((mb_strlen($this->container['security_question1_value']) < 2)) {
            $invalidProperties[] = "invalid value for 'security_question1_value', the character length must be bigger than or equal to 2.";
        }

        if ($this->container['security_question2_type'] === null) {
            $invalidProperties[] = "'security_question2_type' can't be null";
        }
        if ($this->container['security_question2_value'] === null) {
            $invalidProperties[] = "'security_question2_value' can't be null";
        }
        if ((mb_strlen($this->container['security_question2_value']) > 33)) {
            $invalidProperties[] = "invalid value for 'security_question2_value', the character length must be smaller than or equal to 33.";
        }

        if ((mb_strlen($this->container['security_question2_value']) < 2)) {
            $invalidProperties[] = "invalid value for 'security_question2_value', the character length must be bigger than or equal to 2.";
        }
    ...
    /**
     * Gets security_question1_type
     *
     * @return string
     */
    public function getSecurityQuestion1Type()
    {
        return $this->container['security_question1_type'];
    }

    /**
     * Sets security_question1_type
     *
     * @param string $security_question1_type security_question1_type
     *
     * @return self
     */
    public function setSecurityQuestion1Type($security_question1_type)
    {
        if (is_null($security_question1_type)) {
            throw new \InvalidArgumentException('non-nullable security_question1_type cannot be null');
        }
        $this->container['security_question1_type'] = $security_question1_type;

        return $this;
    }

    /**
     * Gets security_question1_value
     *
     * @return string
     */
    public function getSecurityQuestion1Value()
    {
        return $this->container['security_question1_value'];
    }

    /**
     * Sets security_question1_value
     *
     * @param string $security_question1_value security_question1_value
     *
     * @return self
     */
    public function setSecurityQuestion1Value($security_question1_value)
    {
        if (is_null($security_question1_value)) {
            throw new \InvalidArgumentException('non-nullable security_question1_value cannot be null');
        }
        if ((mb_strlen($security_question1_value) > 33)) {
            throw new \InvalidArgumentException('invalid length for $security_question1_value when calling PutV1AccountSecurityQuestionsRequest., must be smaller than or equal to 33.');
        }
        if ((mb_strlen($security_question1_value) < 2)) {
            throw new \InvalidArgumentException('invalid length for $security_question1_value when calling PutV1AccountSecurityQuestionsRequest., must be bigger than or equal to 2.');
        }

        $this->container['security_question1_value'] = $security_question1_value;

        return $this;
    }

    /**
     * Gets security_question2_type
     *
     * @return string
     */
    public function getSecurityQuestion2Type()
    {
        return $this->container['security_question2_type'];
    }

    /**
     * Sets security_question2_type
     *
     * @param string $security_question2_type security_question2_type
     *
     * @return self
     */
    public function setSecurityQuestion2Type($security_question2_type)
    {
        if (is_null($security_question2_type)) {
            throw new \InvalidArgumentException('non-nullable security_question2_type cannot be null');
        }
        $this->container['security_question2_type'] = $security_question2_type;

        return $this;
    }

    /**
     * Gets security_question2_value
     *
     * @return string
     */
    public function getSecurityQuestion2Value()
    {
        return $this->container['security_question2_value'];
    }

    /**
     * Sets security_question2_value
     *
     * @param string $security_question2_value security_question2_value
     *
     * @return self
     */
    public function setSecurityQuestion2Value($security_question2_value)
    {
        if (is_null($security_question2_value)) {
            throw new \InvalidArgumentException('non-nullable security_question2_value cannot be null');
        }
        if ((mb_strlen($security_question2_value) > 33)) {
            throw new \InvalidArgumentException('invalid length for $security_question2_value when calling PutV1AccountSecurityQuestionsRequest., must be smaller than or equal to 33.');
        }
        if ((mb_strlen($security_question2_value) < 2)) {
            throw new \InvalidArgumentException('invalid length for $security_question2_value when calling PutV1AccountSecurityQuestionsRequest., must be bigger than or equal to 2.');
        }

        $this->container['security_question2_value'] = $security_question2_value;

<?php
/**
 * GetV1CarrierServices200ResponseShippingOptionsInnerServicesInnerPackagingOptionsInner
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * GetV1CarrierServices200ResponseShippingOptionsInnerServicesInnerPackagingOptionsInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetV1CarrierServices200ResponseShippingOptionsInnerServicesInnerPackagingOptionsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_v1_carrier_services_200_response_shipping_options_inner_services_inner_packaging_options_inner';
    ...
    protected static $openAPITypes = [
        ...
        'content_options' => '\OpenAPI\Client\Model\GetV1CarrierServices200ResponseShippingOptionsInnerServicesInnerPackagingOptionsInnerContentOptionsInner[]'
    ];
    ...
    protected static $setters = [
        ...
        'packaging_name' => 'setPackagingName',
        'content_options' => 'setContentOptions'
    ];
    ...
    protected static $getters = [
        ...
        'packaging_name' => 'getPackagingName',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('packaging_name', $data ?? [], null);
        $this->setIfExists('content_options', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['packaging_name'];
    }

    /**
     * Sets packaging_name
     *
     * @param string|null $packaging_name packaging_name
     *
     * @return self
     */
    public function setPackagingName($packaging_name)
    {
        if (is_null($packaging_name)) {
            throw new \InvalidArgumentException('non-nullable packaging_name cannot be null');
        }
        $this->container['packaging_name'] = $packaging_name;

        return $this;
    }

    /**
     * Gets content_options
     *
     * @return \OpenAPI\Client\Model\GetV1CarrierServices200ResponseShippingOptionsInnerServicesInnerPackagingOptionsInnerContentOptionsInner[]|null
     */
    public function getContentOptions()
    {
        return $this->container['content_options'];
    }

    /**
     * Sets content_options
     *
     * @param \OpenAPI\Client\Model\GetV1CarrierServices200ResponseShippingOptionsInnerServicesInnerPackagingOptionsInnerContentOptionsInner[]|null $content_options content_options
     *
     * @return self
     */
    public function setContentOptions($content_options)
    {
        if (is_null($content_options)) {
            throw new \InvalidArgumentException('non-nullable content_options cannot be null');
        }
        $this->container['content_options'] = $content_options;

...
/**
 * AdvancedOptionsRegisteredMail Class Doc Comment
 *
 * @category Class
 * @description _Registered Mail_
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class AdvancedOptionsRegisteredMail implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'advanced_options_registered_mail';
    ...
    */
     ...
     * Sets amount
     *
     * @param float|null $amount _Registered Mail Amount_
     *
     * @return self
     */
     ...
     * Sets currency
     *
     * @param string|null $currency _Registered Mail Currency_
     *
     * @return self
     */

...
/**
 * GetV1Url200Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetV1Url200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_v1_url_200_response';
    ...
    */
     ...
     * Sets url
     *
     * @param string $url Returns Stamps.com/Endicia domains depending on the account's merchant
     *
     * @return self
     */

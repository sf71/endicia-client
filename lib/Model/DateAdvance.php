 ...
 */
class DateAdvance implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'date_advance';
    ...
    protected static $openAPITypes = [
        'max_date_advance_envelope' => 'int',
        'max_date_advance_mailing_label' => 'int',
        'max_date_advance_shipping_label' => 'int'
    ];
    ...
    protected static $openAPIFormats = [
        'max_date_advance_envelope' => null,
        'max_date_advance_mailing_label' => null,
        'max_date_advance_shipping_label' => null
    ];
    ...
    protected static array $openAPINullables = [
        'max_date_advance_envelope' => false,
		'max_date_advance_mailing_label' => false,
		'max_date_advance_shipping_label' => false
    ];
    ...
    protected static $attributeMap = [
        'max_date_advance_envelope' => 'max_date_advance_envelope',
        'max_date_advance_mailing_label' => 'max_date_advance_mailing_label',
        'max_date_advance_shipping_label' => 'max_date_advance_shipping_label'
    ];
    ...
    protected static $setters = [
        'max_date_advance_envelope' => 'setMaxDateAdvanceEnvelope',
        'max_date_advance_mailing_label' => 'setMaxDateAdvanceMailingLabel',
        'max_date_advance_shipping_label' => 'setMaxDateAdvanceShippingLabel'
    ];
    ...
    protected static $getters = [
        'max_date_advance_envelope' => 'getMaxDateAdvanceEnvelope',
        'max_date_advance_mailing_label' => 'getMaxDateAdvanceMailingLabel',
        'max_date_advance_shipping_label' => 'getMaxDateAdvanceShippingLabel'
    ];
    ...
    {
        $this->setIfExists('max_date_advance_envelope', $data ?? [], null);
        $this->setIfExists('max_date_advance_mailing_label', $data ?? [], null);
        $this->setIfExists('max_date_advance_shipping_label', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets max_date_advance_envelope
     *
     * @return int|null
     */
    public function getMaxDateAdvanceEnvelope()
    {
        return $this->container['max_date_advance_envelope'];
    }

    /**
     * Sets max_date_advance_envelope
     *
     * @param int|null $max_date_advance_envelope max_date_advance_envelope
     *
     * @return self
     */
    public function setMaxDateAdvanceEnvelope($max_date_advance_envelope)
    {
        if (is_null($max_date_advance_envelope)) {
            throw new \InvalidArgumentException('non-nullable max_date_advance_envelope cannot be null');
        }
        $this->container['max_date_advance_envelope'] = $max_date_advance_envelope;

        return $this;
    }

    /**
     * Gets max_date_advance_mailing_label
     *
     * @return int|null
     */
    public function getMaxDateAdvanceMailingLabel()
    {
        return $this->container['max_date_advance_mailing_label'];
    }

    /**
     * Sets max_date_advance_mailing_label
     *
     * @param int|null $max_date_advance_mailing_label max_date_advance_mailing_label
     *
     * @return self
     */
    public function setMaxDateAdvanceMailingLabel($max_date_advance_mailing_label)
    {
        if (is_null($max_date_advance_mailing_label)) {
            throw new \InvalidArgumentException('non-nullable max_date_advance_mailing_label cannot be null');
        }
        $this->container['max_date_advance_mailing_label'] = $max_date_advance_mailing_label;

        return $this;
    }

    /**
     * Gets max_date_advance_shipping_label
     *
     * @return int|null
     */
    public function getMaxDateAdvanceShippingLabel()
    {
        return $this->container['max_date_advance_shipping_label'];
    }

    /**
     * Sets max_date_advance_shipping_label
     *
     * @param int|null $max_date_advance_shipping_label max_date_advance_shipping_label
     *
     * @return self
     */
    public function setMaxDateAdvanceShippingLabel($max_date_advance_shipping_label)
    {
        if (is_null($max_date_advance_shipping_label)) {
            throw new \InvalidArgumentException('non-nullable max_date_advance_shipping_label cannot be null');
        }
        $this->container['max_date_advance_shipping_label'] = $max_date_advance_shipping_label;

<?php
/**
 * GetV1SecurityQuestions200ResponseInner
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * GetV1SecurityQuestions200ResponseInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetV1SecurityQuestions200ResponseInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_v1_security_questions_200_response_inner';
    ...
    protected static $attributeMap = [
        ...
        'security_question_type' => 'security_question_type'
    ];
    ...
    protected static $setters = [
        ...
        'security_question_type' => 'setSecurityQuestionType'
    ];
    ...
    protected static $getters = [
        ...
        'security_question_type' => 'getSecurityQuestionType'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('security_question_type', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @param string|null $security_question security_question
     *
     * @return self
     */
    ...
    /**
     * Gets security_question_type
     *
     * @return string|null
     */
    public function getSecurityQuestionType()
    {
        return $this->container['security_question_type'];
    }

    /**
     * Sets security_question_type
     *
     * @param string|null $security_question_type security_question_type
     *
     * @return self
     */
    public function setSecurityQuestionType($security_question_type)
    {
        if (is_null($security_question_type)) {
            throw new \InvalidArgumentException('non-nullable security_question_type cannot be null');
        }
        $this->container['security_question_type'] = $security_question_type;

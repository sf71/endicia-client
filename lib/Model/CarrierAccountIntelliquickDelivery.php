<?php
/**
 * CarrierAccountIntelliquickDelivery
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * CarrierAccountIntelliquickDelivery Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CarrierAccountIntelliquickDelivery implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'carrier_account_intelliquick_delivery';
    ...
    {
        $this->setIfExists('user_owned_account', $data ?? [], true);

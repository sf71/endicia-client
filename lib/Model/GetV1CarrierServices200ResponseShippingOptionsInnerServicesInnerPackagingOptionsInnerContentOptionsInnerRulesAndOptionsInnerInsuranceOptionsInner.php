...
/**
 * GetV1CarrierServices200ResponseShippingOptionsInnerServicesInnerPackagingOptionsInnerContentOptionsInnerRulesAndOptionsInnerInsuranceOptionsInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetV1CarrierServices200ResponseShippingOptionsInnerServicesInnerPackagingOptionsInnerContentOptionsInnerRulesAndOptionsInnerInsuranceOptionsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_v1_carrier_services_200_response_shipping_options_inner_services_inner_packaging_options_inner_content_options_inner_rules_and_options_inner_insurance_options_inner';
    ...
    protected static $openAPITypes = [
        ...
        'max_insurance_value_limit' => 'float',
        'included_insurance_amount' => 'float',
        'currency' => 'string'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'max_insurance_value_limit' => null,
        'included_insurance_amount' => null,
        'currency' => null
    ];
    ...
    protected static array $openAPINullables = [
		...
		'insurance_provider_name' => false,
		'max_insurance_value_limit' => false,
		'included_insurance_amount' => false,
		'currency' => false
    ];
    ...
    protected static $attributeMap = [
        ...
        'max_insurance_value_limit' => 'max_insurance_value_limit',
        'included_insurance_amount' => 'included_insurance_amount',
        'currency' => 'currency'
    ];
    ...
    protected static $setters = [
        ...
        'insurance_provider_name' => 'setInsuranceProviderName',
        'max_insurance_value_limit' => 'setMaxInsuranceValueLimit',
        'included_insurance_amount' => 'setIncludedInsuranceAmount',
    ...
    protected static $getters = [
        ...
        'insurance_provider_name' => 'getInsuranceProviderName',
        'max_insurance_value_limit' => 'getMaxInsuranceValueLimit',
        'included_insurance_amount' => 'getIncludedInsuranceAmount',
    ...
    {
        $this->setIfExists('insurance_provider', $data ?? [], null);
        $this->setIfExists('insurance_provider_name', $data ?? [], null);
        $this->setIfExists('max_insurance_value_limit', $data ?? [], null);
        $this->setIfExists('included_insurance_amount', $data ?? [], null);
    ...
    */
     ...
     *
     * @param string|null $insurance_provider insurance_provider
     *
     * @return self
     */
    public function setInsuranceProvider($insurance_provider)
    {
        if (is_null($insurance_provider)) {
            throw new \InvalidArgumentException('non-nullable insurance_provider cannot be null');
        }
    ...
    /**
     * Gets insurance_provider_name
     *
     * @return string|null
     */
    public function getInsuranceProviderName()
    {
        return $this->container['insurance_provider_name'];
    }

    /**
     * Sets insurance_provider_name
     *
     * @param string|null $insurance_provider_name insurance_provider_name
     *
     * @return self
     */
    public function setInsuranceProviderName($insurance_provider_name)
    {
        if (is_null($insurance_provider_name)) {
            throw new \InvalidArgumentException('non-nullable insurance_provider_name cannot be null');
        }
        $this->container['insurance_provider_name'] = $insurance_provider_name;

        return $this;
    }

    /**
     * Gets max_insurance_value_limit
     *
     * @return float|null
     */
    public function getMaxInsuranceValueLimit()
    {
        return $this->container['max_insurance_value_limit'];
    }

    /**
     * Sets max_insurance_value_limit
     *
     * @param float|null $max_insurance_value_limit max_insurance_value_limit
     *
     * @return self
     */
    public function setMaxInsuranceValueLimit($max_insurance_value_limit)
    {
        if (is_null($max_insurance_value_limit)) {
            throw new \InvalidArgumentException('non-nullable max_insurance_value_limit cannot be null');
        }
        $this->container['max_insurance_value_limit'] = $max_insurance_value_limit;

        return $this;
    }

    /**
     * Gets included_insurance_amount
     *
     * @return float|null
     */
    public function getIncludedInsuranceAmount()
    {
        return $this->container['included_insurance_amount'];
    }

    /**
     * Sets included_insurance_amount
     *
     * @param float|null $included_insurance_amount included_insurance_amount
     *
     * @return self
     */
    public function setIncludedInsuranceAmount($included_insurance_amount)
    {
        if (is_null($included_insurance_amount)) {
            throw new \InvalidArgumentException('non-nullable included_insurance_amount cannot be null');
        }
        $this->container['included_insurance_amount'] = $included_insurance_amount;

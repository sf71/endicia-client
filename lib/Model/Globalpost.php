 ...
 */
class Globalpost implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'globalpost';
    ...
    protected static $attributeMap = [
        'first_mile_carrier' => 'first_mile_carrier'
    ];
    ...
    protected static $setters = [
        'first_mile_carrier' => 'setFirstMileCarrier'
    ];
    ...
    protected static $getters = [
        'first_mile_carrier' => 'getFirstMileCarrier'
    ];
    ...
    public const FIRST_MILE_CARRIER_NONE = 'none';
    public const FIRST_MILE_CARRIER_USPS = 'usps';
    public const FIRST_MILE_CARRIER_DHL = 'dhl';
     ...
     * @return string[]
     */
    public function getFirstMileCarrierAllowableValues()
    {
        return [
            self::FIRST_MILE_CARRIER_NONE,
            self::FIRST_MILE_CARRIER_USPS,
            self::FIRST_MILE_CARRIER_DHL,
        ];
    }
    ...
    {
        $this->setIfExists('first_mile_carrier', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getFirstMileCarrierAllowableValues();
        if (!is_null($this->container['first_mile_carrier']) && !in_array($this->container['first_mile_carrier'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'first_mile_carrier', must be one of '%s'",
                $this->container['first_mile_carrier'],
    ...
    /**
     * Gets first_mile_carrier
     *
     * @return string|null
     */
    public function getFirstMileCarrier()
    {
        return $this->container['first_mile_carrier'];
    }

    /**
     * Sets first_mile_carrier
     *
     * @param string|null $first_mile_carrier _First Mile Carrier_
     *
     * @return self
     */
    public function setFirstMileCarrier($first_mile_carrier)
    {
        if (is_null($first_mile_carrier)) {
            throw new \InvalidArgumentException('non-nullable first_mile_carrier cannot be null');
        }
        $allowedValues = $this->getFirstMileCarrierAllowableValues();
        if (!in_array($first_mile_carrier, $allowedValues, true)) {
        ...
        $this->container['first_mile_carrier'] = $first_mile_carrier;

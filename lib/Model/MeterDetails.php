...
/**
 * MeterDetails Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class MeterDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'meter_details';
    ...
    protected static $openAPITypes = [
        'meter_number' => 'int',
        'meter_address' => '\OpenAPI\Client\Model\Address',
    ...
    protected static $setters = [
        ...
        'meter_address' => 'setMeterAddress',
        'meter_provider' => 'setMeterProvider'
    ];
    ...
    protected static $getters = [
        ...
        'meter_address' => 'getMeterAddress',
        'meter_provider' => 'getMeterProvider'
    ];
    ...
    {
        $this->setIfExists('meter_number', $data ?? [], null);
        $this->setIfExists('meter_address', $data ?? [], null);
        $this->setIfExists('meter_provider', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets meter_number
     *
     * @param int|null $meter_number _Meter Number_
     *
     * @return self
     */
    public function setMeterNumber($meter_number)
    {
        if (is_null($meter_number)) {
            throw new \InvalidArgumentException('non-nullable meter_number cannot be null');
        }
     ...
     */
    public function getMeterAddress()
    {
        return $this->container['meter_address'];
    }

    /**
     * Sets meter_address
     *
     * @param \OpenAPI\Client\Model\Address|null $meter_address meter_address
     *
     * @return self
     */
    public function setMeterAddress($meter_address)
    {
        if (is_null($meter_address)) {
            throw new \InvalidArgumentException('non-nullable meter_address cannot be null');
        }
        $this->container['meter_address'] = $meter_address;
    ...
    {
        return $this->container['meter_provider'];
    }

    /**
     * Sets meter_provider
     *
     * @param string|null $meter_provider _Meter Provider_
     *
     * @return self
     */
    public function setMeterProvider($meter_provider)
    {
        if (is_null($meter_provider)) {
            throw new \InvalidArgumentException('non-nullable meter_provider cannot be null');
        }
        $this->container['meter_provider'] = $meter_provider;

...
/**
 * ShipmentCost Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  OpenAPI\Client
 ...
 */
class ShipmentCost implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'shipment_cost';
    ...
    protected static $openAPITypes = [
        'total_amount' => 'float',
        'currency' => 'string',
        'cost_details' => '\OpenAPI\Client\Model\ShipmentCostCostDetailsInner[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('cost_details', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets cost_details
     *
     * @return \OpenAPI\Client\Model\ShipmentCostCostDetailsInner[]|null
     */
     ...
     * Sets cost_details
     *
     * @param \OpenAPI\Client\Model\ShipmentCostCostDetailsInner[]|null $cost_details cost_details
     *
     * @return self
     */
    public function setCostDetails($cost_details)
    {
        if (is_null($cost_details)) {
            throw new \InvalidArgumentException('non-nullable cost_details cannot be null');
        }

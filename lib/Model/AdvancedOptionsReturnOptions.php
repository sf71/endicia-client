...
/**
 * AdvancedOptionsReturnOptions Class Doc Comment
 *
 * @category Class
 * @description _Return Options_
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class AdvancedOptionsReturnOptions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'advanced_options_return_options';
    ...
    {
        $this->setIfExists('outbound_label_id', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @param string|null $outbound_label_id _Return Outbound Label ID_<br/>Specify the `label_id` of the outbound label for a paired return label
     *
     * @return self
     */
    public function setOutboundLabelId($outbound_label_id)
    {
        if (is_null($outbound_label_id)) {
            throw new \InvalidArgumentException('non-nullable outbound_label_id cannot be null');
        }

<?php
/**
 * CustomsCustomsItemsInnerUnitValue
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * CustomsCustomsItemsInnerUnitValue Class Doc Comment
 *
 * @category Class
 * @description _Customs Item Unit Value_
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CustomsCustomsItemsInnerUnitValue implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'customs_customs_items_inner_unit_value';

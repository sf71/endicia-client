<?php
/**
 * PostV1RatesRequestInsuranceInsuredValue
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PostV1RatesRequestInsuranceInsuredValue Class Doc Comment
 *
 * @category Class
 * @description _Insured Value_
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class PostV1RatesRequestInsuranceInsuredValue implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_v1_rates_request_insurance_insured_value';
    ...
    */
     ...
     * Sets amount
     *
     * @param float|null $amount _Insured Value Amount_
     *
     * @return self
     */
     ...
     * Sets currency
     *
     * @param string|null $currency _Insured Value Currency_
     *
     * @return self
     */

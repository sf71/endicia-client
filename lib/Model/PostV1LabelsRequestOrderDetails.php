<?php
/**
 * PostV1LabelsRequestOrderDetails
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PostV1LabelsRequestOrderDetails Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PostV1LabelsRequestOrderDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_v1_labels_request_order_details';
    ...
    protected static $openAPITypes = [
        'order_source' => 'string',
        'order_number' => 'string',
        'items_ordered' => '\OpenAPI\Client\Model\PostV1LabelsRequestOrderDetailsItemsOrderedInner[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('items_ordered', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets items_ordered
     *
     * @return \OpenAPI\Client\Model\PostV1LabelsRequestOrderDetailsItemsOrderedInner[]|null
     */
    public function getItemsOrdered()
    {
        return $this->container['items_ordered'];
    }

    /**
     * Sets items_ordered
     *
     * @param \OpenAPI\Client\Model\PostV1LabelsRequestOrderDetailsItemsOrderedInner[]|null $items_ordered items_ordered
     *
     * @return self
     */
    public function setItemsOrdered($items_ordered)
    {
        if (is_null($items_ordered)) {
            throw new \InvalidArgumentException('non-nullable items_ordered cannot be null');
        }
        $this->container['items_ordered'] = $items_ordered;

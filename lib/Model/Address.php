...
class Address implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('residential_indicator', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets company_name
     *
     * @param string|null $company_name _Company Name_
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name _Full Name_
     *
     * @return self
     */
     ...
     * Sets address_line1
     *
     * @param string|null $address_line1 _Address Line 1_
     *
     * @return self
     */
     ...
     * Sets address_line2
     *
     * @param string|null $address_line2 _Address Line 2_
     *
     * @return self
     */
     ...
     * Sets address_line3
     *
     * @param string|null $address_line3 _Address Line 3_
     *
     * @return self
     */
     ...
     * Sets state_province
     *
     * @param string|null $state_province _State/Province_
     *
     * @return self
     */
     ...
     * Sets postal_code
     *
     * @param string|null $postal_code _Postal/ZIP Code_
     *
     * @return self
     */
     ...
     * Sets country_code
     *
     * @param string|null $country_code _Country Code_<br/>ISO 3166 alpha-2 Country Code
     *
     * @return self
     */
     ...
     * Sets phone
     *
     * @param string|null $phone _Phone Number_
     *
     * @return self
     */
     ...
     * Sets email
     *
     * @param string|null $email _Email Address_
     *
     * @return self
     */
     ...
     *
     * @param string|null $residential_indicator _Residential Indicator_
     *
     * @return self
     */
    public function setResidentialIndicator($residential_indicator)
    {
        if (is_null($residential_indicator)) {
            throw new \InvalidArgumentException('non-nullable residential_indicator cannot be null');
        }

<?php
/**
 * GetV1Tracking200ResponseTrackingEventsInner
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * GetV1Tracking200ResponseTrackingEventsInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetV1Tracking200ResponseTrackingEventsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_v1_tracking_200_response_tracking_events_inner';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('carrier_status_code', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @param string|null $carrier_status_code carrier_status_code
     *
     * @return self
     */
    public function setCarrierStatusCode($carrier_status_code)
    {
        if (is_null($carrier_status_code)) {
            throw new \InvalidArgumentException('non-nullable carrier_status_code cannot be null');
        }

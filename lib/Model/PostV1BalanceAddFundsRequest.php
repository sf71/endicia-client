...
/**
 * PostV1BalanceAddFundsRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PostV1BalanceAddFundsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_v1_balance_add_funds_request';
    ...
    */
     ...
     * Sets amount
     *
     * @param float|null $amount _Amount_<br/>The amount to add to the account balance
     *
     * @return self
     */
     ...
     * Sets currency
     *
     * @param string|null $currency _Currency_<br/>The currency used for the amount
     *
     * @return self
     */

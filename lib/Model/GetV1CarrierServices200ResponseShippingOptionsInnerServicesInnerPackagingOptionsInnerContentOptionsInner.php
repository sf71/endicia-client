<?php
/**
 * GetV1CarrierServices200ResponseShippingOptionsInnerServicesInnerPackagingOptionsInnerContentOptionsInner
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * GetV1CarrierServices200ResponseShippingOptionsInnerServicesInnerPackagingOptionsInnerContentOptionsInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetV1CarrierServices200ResponseShippingOptionsInnerServicesInnerPackagingOptionsInnerContentOptionsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_v1_carrier_services_200_response_shipping_options_inner_services_inner_packaging_options_inner_content_options_inner';
    ...
    protected static $openAPITypes = [
        ...
        'rules_and_options' => '\OpenAPI\Client\Model\GetV1CarrierServices200ResponseShippingOptionsInnerServicesInnerPackagingOptionsInnerContentOptionsInnerRulesAndOptionsInner[]'
    ];
    ...
    protected static array $openAPINullables = [
        'shipment_contents' => false,
		'rules_and_options' => false
    ];
    ...
    protected static $attributeMap = [
        'shipment_contents' => 'shipment_contents',
        'rules_and_options' => 'rules_and_options'
    ];
    ...
    protected static $setters = [
        'shipment_contents' => 'setShipmentContents',
        'rules_and_options' => 'setRulesAndOptions'
    ];
    ...
    protected static $getters = [
        'shipment_contents' => 'getShipmentContents',
        'rules_and_options' => 'getRulesAndOptions'
    ];
    ...
    {
        $this->setIfExists('shipment_contents', $data ?? [], null);
        $this->setIfExists('rules_and_options', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets shipment_contents
     *
     * @return string|null
     */
    public function getShipmentContents()
    {
        return $this->container['shipment_contents'];
    }

    /**
     * Sets shipment_contents
     *
     * @param string|null $shipment_contents shipment_contents
     *
     * @return self
     */
    public function setShipmentContents($shipment_contents)
    {
        if (is_null($shipment_contents)) {
            throw new \InvalidArgumentException('non-nullable shipment_contents cannot be null');
        }
        $this->container['shipment_contents'] = $shipment_contents;

        return $this;
    }

    /**
     * Gets rules_and_options
     *
     * @return \OpenAPI\Client\Model\GetV1CarrierServices200ResponseShippingOptionsInnerServicesInnerPackagingOptionsInnerContentOptionsInnerRulesAndOptionsInner[]|null
     */
    public function getRulesAndOptions()
    {
        return $this->container['rules_and_options'];
    }

    /**
     * Sets rules_and_options
     *
     * @param \OpenAPI\Client\Model\GetV1CarrierServices200ResponseShippingOptionsInnerServicesInnerPackagingOptionsInnerContentOptionsInnerRulesAndOptionsInner[]|null $rules_and_options rules_and_options
     *
     * @return self
     */
    public function setRulesAndOptions($rules_and_options)
    {
        if (is_null($rules_and_options)) {
            throw new \InvalidArgumentException('non-nullable rules_and_options cannot be null');
        }
        $this->container['rules_and_options'] = $rules_and_options;

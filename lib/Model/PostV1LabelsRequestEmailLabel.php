...
/**
 * PostV1LabelsRequestEmailLabel Class Doc Comment
 *
 * @category Class
 * @description _Email Label_&lt;br/&gt;Used to email the generated label
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class PostV1LabelsRequestEmailLabel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_v1_labels_request_email_label';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('email_notes', $data ?? [], null);
    ...
    */
     ...
     * Sets email_notes
     *
     * @param string|null $email_notes email_notes
     *
     * @return self
     */
    public function setEmailNotes($email_notes)
    {
        if (is_null($email_notes)) {
            throw new \InvalidArgumentException('non-nullable email_notes cannot be null');
        }

<?php
/**
 * PostV1Pickups200ResponseEstimatedCost
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PostV1Pickups200ResponseEstimatedCost Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PostV1Pickups200ResponseEstimatedCost implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_v1_pickups_200_response_estimated_cost';
    ...
    */
     ...
     * Sets currency
     *
     * @param string|null $currency The currency used for the associated `amount`.
     *
     * @return self
     */

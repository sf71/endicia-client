 ...
 */
class Resubmit implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'resubmit';
    ...
    public const STATUS_NOT_IN_RESUBMISSION = 'not_in_resubmission';
    public const STATUS_PAYMENT_RESUBMISSION = 'payment_resubmission';
    public const STATUS_NON_CORRECTABLE_PAYMENT_RESUBMISSION = 'non_correctable_payment_resubmission';
    ...
    {
        return [
            self::STATUS_NOT_IN_RESUBMISSION,
            self::STATUS_PAYMENT_RESUBMISSION,
            self::STATUS_NON_CORRECTABLE_PAYMENT_RESUBMISSION,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('cookie', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets status
     *
     * @param string|null $status _Status_
     *
     * @return self
     */
     ...
     * Sets cookie
     *
     * @param string|null $cookie _Cookie_
     *
     * @return self
     */
    ...
    {
        if (is_null($cookie)) {
            throw new \InvalidArgumentException('non-nullable cookie cannot be null');
        }

...
class PlanDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'plan_details';
    ...
    protected static $attributeMap = [
        ...
        'cost_code_limit' => 'cost_code_limit',
        'max_users' => 'max_users'
    ];
    ...
    protected static $setters = [
        'plan_id' => 'setPlanId',
        'pending_plan_id' => 'setPendingPlanId',
        'cost_code_limit' => 'setCostCodeLimit',
    ...
    protected static $getters = [
        'plan_id' => 'getPlanId',
        'pending_plan_id' => 'getPendingPlanId',
        'cost_code_limit' => 'getCostCodeLimit',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('pending_plan_id', $data ?? [], null);
        $this->setIfExists('cost_code_limit', $data ?? [], null);
    ...
    */
     ...
     * Sets plan_id
     *
     * @param string|null $plan_id _Plan ID_
     *
     * @return self
     */
    ...
    /**
     * Gets pending_plan_id
     *
     * @return string|null
     */
    public function getPendingPlanId()
    {
        return $this->container['pending_plan_id'];
    }

    /**
     * Sets pending_plan_id
     *
     * @param string|null $pending_plan_id _Pending Plan ID_
     *
     * @return self
     */
    public function setPendingPlanId($pending_plan_id)
    {
        if (is_null($pending_plan_id)) {
            throw new \InvalidArgumentException('non-nullable pending_plan_id cannot be null');
        }
        $this->container['pending_plan_id'] = $pending_plan_id;

        return $this;
    }

    /**
     * Gets cost_code_limit
     *
     * @return int|null
     */
    public function getCostCodeLimit()
    {
        return $this->container['cost_code_limit'];
    }

    /**
     * Sets cost_code_limit
     *
     * @param int|null $cost_code_limit _Cost Code Limit_
     *
     * @return self
     */
    public function setCostCodeLimit($cost_code_limit)
    {
        if (is_null($cost_code_limit)) {
            throw new \InvalidArgumentException('non-nullable cost_code_limit cannot be null');
        }
        $this->container['cost_code_limit'] = $cost_code_limit;
     ...
     * Sets max_users
     *
     * @param int|null $max_users _Max Users_
     *
     * @return self
     */

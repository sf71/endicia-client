...
/**
 * PostOauthToken200Response Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PostOauthToken200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_oauth_token_200_response';
    ...
    */
     ...
     * Sets access_token
     *
     * @param string|null $access_token _Access Token_<br/>Used to authenticate for SERA calls
     *
     * @return self
     */
     ...
     * Sets refresh_token
     *
     * @param string|null $refresh_token _Refresh Token_<br/>This can be used to generate a new access token as needed
     *
     * @return self
     */
     ...
     * Sets id_token
     *
     * @param string|null $id_token _ID Token_
     *
     * @return self
     */
     ...
     * Sets token_type
     *
     * @param string|null $token_type _Token Type_<br/>Returned as \"Bearer\"
     *
     * @return self
     */
     ...
     * Sets expires_in
     *
     * @param string|null $expires_in _Expires In_<br/>Access token expires in these many seconds
     *
     * @return self
     */
